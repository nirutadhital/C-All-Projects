...
namespace jwtDb.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<ActionResult<User>> Register(User request)
        {
            ...
            {
                return Ok(registeredUser); // Return Ok with the registered user object
            }
            else
            {
                return BadRequest("Failed to register user."); // Return BadRequest if registration failed
            }
        }
